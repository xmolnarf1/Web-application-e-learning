...
<div class="container">
    <div class="tests-container">
        <div class="tests-header d-flex justify-content-between align-items-center">
            <div>
                <h2 class="tests-title">
                    <i class="fas fa-question-circle me-2"></i><?= $lang['teacher']['available_material_t'] ?>
                </h2>
                <p class="text-muted"><?= ($_SESSION['lang'] == 'sk') ? 'Prehľad všetkých dostupných testov' : 'Overview of all available tests' ?></p>
            </div>
            <a href="quizzCreate.php" class="btn btn-primary">
                <i class="fas fa-plus me-1"></i> <?= $lang['teacher']['add_new_t'] ?>
            </a>
        </div>
